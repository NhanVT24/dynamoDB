...
const fashionColors = ["Den", "Trang", "Xanh navy", "Kem"];
const fashionSizes = ["S", "M", "L", "XL"];
const materials = ["Cotton", "Jean", "Da PU", "Polyester"];
const voltages = ["220V", "110V", "5V USB-C"];
const ageRanges = ["0-6 thang", "6-12 thang", "1-3 tuoi", "3-6 tuoi"];
const skinTypes = ["Da dau", "Da kho", "Da hon hop", "Moi loai da"];
const categoryNamePrefixes = {
  "Thoi trang": "Ao",
  "Dien tu": "Tai nghe",
  "Gia dung": "Noi",
  "Me va be": "Ta",
...
function buildCategorySpecificAttributes(category, index) {
