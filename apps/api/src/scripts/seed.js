...
const categories = ["Thời trang", "Điện tử", "Gia dụng", "Mẹ và bé", "Làm đẹp", "Bách hóa"];
const brands = ["FlexWear", "SoundMax", "HomePro", "BabyNest", "PureSkin", "Daily Mart"];
const locations = ["TP.HCM", "Hà Nội", "Đà Nẵng", "Cần Thơ", "Bình Dương", "Hải Phòng"];
...
const sampleShoppingItems = Array.from({ length: 200 }, (_, index) => {
  ...
  return {
    ...
    description: `Mô tả ngắn cho sản phẩm ${index + 1} thuộc danh mục ${category}.`,
